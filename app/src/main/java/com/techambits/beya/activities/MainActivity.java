...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  Log.w("Encrytp ::::: ", Encriptar("ilv_2312313123123"));
        try {
            Log.w("Encrytp ::::: ", Desencriptar("X8VJ3Fk8ph+I0VCpf3kHWIEMi1sFCTBX"));
        } catch (Exception e) {
            e.printStackTrace();
        }*/
    ...
    public void onStart() {
      ...
      /*  // ATTENTION: This was auto-generated to implement the App Indexing API.
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.elements.beya.activities/http/host/path")
        );
